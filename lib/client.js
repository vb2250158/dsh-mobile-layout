...
function annotateFrame(frame) {
  ...
  const header = frame.querySelector("[data-dsh-mobile-conversation] > [data-phase] > header");
...
function CompactOverlay({ toggleSidebar, t }) {
  ...
  if (!compact) return /* @__PURE__ */ React.createElement("div", { ref: hostRef, className: "dsh-mobile-layout-host" });
  const menu = collectMobileMenuItems(frameRef.current);
  const hasMore = menu.items.length > 0 || menu.info.length > 0;
  void revision;
  return /* @__PURE__ */ React.createElement("div", { ref: hostRef, className: "dsh-mobile-layout-host" }, /* @__PURE__ */ React.createElement("div", { className: "dsh-mobile-layout-topbar", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
  ...
  )))), drawerOpen && /* @__PURE__ */ React.createElement("button", { type: "button", className: "dsh-mobile-layout-scrim", "aria-label": t("menu.close"), onClick: closeDrawer }));
}
